...
export default function Hero() {
  return (
    <section className="pt-40 pb-20 px-6 text-center relative overflow-hidden min-h-[90vh] flex flex-col justify-center">
      ...
      >
        THE ai voice studio <br/><span className="text-[#00FF41] underline decoration-[#FF003C] underline-offset-8">PROTOCOL.</span>
      </motion.h1>
      ...
      >
        Build an AI voice cloning interface. Engineered for extreme data density and uncompromising security.
      </motion.p>
